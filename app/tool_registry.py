...
TOOL_DESCRIPTIONS = {
    ...
    ActionType.adaptive_observe: "adaptive_observe: {\"app\": str|null, \"cap\": int|null} - build a compact affordance graph and runtime plan for an unfamiliar Windows app/window: grouped UIA controls, likely text inputs, commands, menus, navigation targets, plus whether to use UIA, Electron unlock, OCR, keyboard/visual, or window resolution next. Use before guessing names in complex apps or after any confusing miss.",
...
TOOL_PACKS = {
    ...
    "uia": [ActionType.adaptive_observe, ActionType.uia_find, ActionType.uia_click, ActionType.uia_click_sequence, ActionType.uia_type, ActionType.uia_wait, ActionType.electron_check, ActionType.electron_unlock, ActionType.focus_window, ActionType.wait_for_window],
